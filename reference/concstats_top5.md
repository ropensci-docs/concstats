...
``` r
concstats_top5(x, na.rm = TRUE, digits = NULL)
```
...
A positive numeric value, which indicates the cumulative sum of the top
5 market shares as a percentage.
