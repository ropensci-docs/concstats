...
- I aim for testing that has high coverage and is robust. Include tests
  with any major contribution to code. Test your changes to the package
  with `testthat`, `goodpractice` and
  [`devtools::check()`](https://devtools.r-lib.org/reference/check.html)
  (aim for 0 errors and warnings) before submitting your change.
...
- I’ll generally include contributors as authors in the DESCRIPTION file
  (with their permission) for most contributions that go beyond small
